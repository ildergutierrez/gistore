// ============================================================
//  categorias.js — Gestión de categorías (PHP + MySQL)
// ============================================================
...
async function cargar() {
  try {
    categorias = await apiGet('categorias.php?accion=obtener');
...
document.getElementById('btnGuardar').addEventListener('click', async () => {
  ...
  try {
    if (id) {
      await apiPost('categorias.php?accion=actualizar', { id, nombre, orden });
      mostrarOk('Categoría actualizada.');
    } else {
      await apiPost('categorias.php?accion=crear', { nombre, orden });
...
document.getElementById('btnConfirmarEliminar').addEventListener('click', async () => {
  ...
  btnCargando(btn, true);
  try {
    await apiPost('categorias.php?accion=eliminar', { id: idEliminar });
