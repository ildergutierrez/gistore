...
async function _getTodosActivos() {
  ...
  // Solo productos de vendedores activos 
...
function compartirProducto(prod) {
  ...
  const texto  = `🌿 ¡Holaaa, mira tú este producto, Puede que te interese!\n*Nombre: ${prod.nombre}*\n💵 Valor: ${formatoPrecio(prod.valor)}\n _Para saber más, de click en el enlace_`;
